...
public class AdicionaContato extends HttpServlet implements Logica{
	...
	public void executa(HttpServletRequest request, HttpServletResponse response)
		...
		Usuario usuario = UsuarioFactory.criaUsuario(request.getParameter("nome"), 
				...
				telefone, celular, new Date(), request.getParameter("dataNascimento"), //ajeitar data de nascimento 
	...
	private String getTelefone(HttpServletRequest request){
	...
	private String getCelular(HttpServletRequest request){
