...
<body>
	<form:form commandName="administradora"
		action="/sindico/criaAdministradora" method="POST">
		<table>
			<tr>
				<td>Nome:</td>
		...
		<table>
			<tr>
				<td>CEP:</td>
				<td><form:input path="cep" onblur="javascript:getCep(cep.value);" /></td>
			</tr>
			<tr>
				<td>Endereço:</td>
			...
			<tr>
				<td colspan="2"><form:button value="Criar">Criar</form:button>
				</td>
			</tr>
		</table>
	</form:form>
